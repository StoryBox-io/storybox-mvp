defmodule Storybox.Stories.ThroughlineView do
  use Ash.Resource,
  ...
  relationships do
    ...
    has_many :throughline_view_versions, Storybox.Stories.ThroughlineViewVersion, public?: true
  end
  ...
  actions do
    ...
    action :ensure_for_story, :struct do
      constraints instance_of: Storybox.Stories.ThroughlineView
