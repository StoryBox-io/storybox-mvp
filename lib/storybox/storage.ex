defmodule Storybox.Storage do
  ...
  def uri_for_throughline_piece(story_id, nil, version_number) do
    "storybox://stories/#{story_id}/throughlines/controlling_idea/v#{version_number}"
  end

  def uri_for_throughline_piece(story_id, character_id, version_number) do
    "storybox://stories/#{story_id}/throughlines/characters/#{character_id}/v#{version_number}"
  end
